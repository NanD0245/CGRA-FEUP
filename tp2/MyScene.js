...
export class MyScene extends CGFscene {
	...
	display() {
		...
		if (this.displayTriangleBig) this.blueTriangleBig.display();
		this.popMatrix();

		this.pushMatrix();
		this.setDiffuse(1, 0.514, 0);
		this.rotate(-3*Math.PI/4, 0, 0, 1);
		if (this.displayTriangleBig) this.orangeTriangleBig.display();
		this.popMatrix();
		...
		if (this.displayTriangleSmall) this.redTriangleSmall.display();
		this.popMatrix();
